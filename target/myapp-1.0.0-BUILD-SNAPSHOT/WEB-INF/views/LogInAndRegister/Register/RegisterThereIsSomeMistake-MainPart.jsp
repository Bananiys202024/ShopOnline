...
<div class="someErrors">
<div class="erorrMAAAAAn" style="white-space: pre-wrap;color: red;">Sorry, but that's code does not match.
You should input code sended to your e-mail</div>
</div>
