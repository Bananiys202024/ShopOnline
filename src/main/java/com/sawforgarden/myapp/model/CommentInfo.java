...
public class CommentInfo {
	...
	private String modifiedPostedDate;
	...
	public CommentInfo(String commentText, String title, double rating, boolean wouldRecommendThisToAFriend) {
	...
	public CommentInfo(String commentText, Date dateTime, boolean deleted,Date modifiedDateTime, String product_id, String title, String nameOfUser,Double rating, boolean thatWasModified, boolean wouldRecommendThisToAFriend) {
	...
	public CommentInfo(String product_id, String commentText, Date dateTime, String id, Date modifiedDateTime, String title, String nameOfUser, boolean WouldRecommendThisToAFriend, double rating, boolean deleted, boolean ThatWasModified) {
		this.setProduct_id(product_id);
		this.setCommentText(commentText);
		this.setModifiedDateTime(modifiedDateTime);
		this.setId(id);
	...
	public CommentInfo(String Id, String commentText, Date dateTime, boolean deleted,Date modifiedDateTime, String product_id, String title, String nameOfUser,Double rating, boolean thatWasModified, boolean wouldRecommendThisToAFriend) {
		this.setProduct_id(product_id);
		this.setCommentText(commentText);
		this.setModifiedDateTime(modifiedDateTime);
		this.setDateTime(dateTime);	
	...
	public CommentInfo(String Id,String product_id, String commentText, Date dateTime, String id, Date modifiedDateTime, String title, String nameOfUser, boolean WouldRecommendThisToAFriend, double rating, boolean deleted, boolean ThatWasModified) {
		this.setProduct_id(product_id);
		this.setCommentText(commentText);
		this.setModifiedDateTime(modifiedDateTime);
		this.setId(id);
	...
	public String getModifiedPostedDate() {
		return modifiedPostedDate;
	}


	public void setModifiedPostedDate(String modifiedPostedDate) {
		this.modifiedPostedDate = modifiedPostedDate;
	}
