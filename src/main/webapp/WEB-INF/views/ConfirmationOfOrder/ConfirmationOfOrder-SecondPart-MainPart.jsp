...
<form:input path="name" placeholder="  Emma Watson" maxlength="60"/>
...
<form:input path="email" placeholder="  ImAclient@gmail.com" maxlength="100"/> 
...
<form:input path="phone" placeholder="  +44_7123_456_789" maxlength="15"/> 
...
<form:input path="address" placeholder="  132, My Street," maxlength="100"/> 
<form:errors path="address" class="error-message" />
</label>

<label for="user.Address">
<span><span class="i18n-paragraph">Город</span></span>
<form:input path="town" placeholder="Odessa, Ukraine" maxlength="60"/> 
